export const defaultNavItems = [{ href: "/", label: "داشبورد", icon: "🏠" }];

export const adminNavItems = [
  { href: "/dashboard/admin", label: "پنل کاربری", icon: "🏠" },
  { href: "/dashboard/admin/profile", label: "پروفایل", icon: "👤" },
  { href: "/dashboard/admin/chat", label: "پشتیبانی", icon: "💬" },
];
